...
const SchoolMarker = ({ school, dateRange, location, degree, conc1, conc2}) => {
    ...
    <Flex direction={'column'} align={'flex-start'} justify={'flex-start'} >
        ...
        <Heading as='h6' size='md'>{ degree }</Heading>
...
const Education = () => {
  ...
  return (
    <Flex flexDirection={'column'} justify={'center'} align={'flex-start'} h={'100%'} marginLeft={10} id='education' gap={10}>
        ...
        <SchoolMarker school={'Ball State University (BSU)'} dateRange={'AUG 2018 - MAY 2022'} location={'Muncie, IN'} degree={'Bachelor of Arts'} conc1={'Computer Science'} conc2={'Video Production'}/>
